...
import com.ideazshuttle.chatwall.activities.Connect_with_itrack;
import com.ideazshuttle.chatwall.models.User;
import com.ideazshuttle.chatwall.services.SinchService;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.connect).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ii = new Intent(getContext(), Connect_with_itrack.class);
                startActivity(ii);
            }
        });
